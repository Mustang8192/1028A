...
lemlib::TrackingWheel _1028A::robot::vertical(&Vertical, lemlib::Omniwheel::NEW_2, -1.5);
lemlib::TrackingWheel _1028A::robot::horizontal(&Horizontal, lemlib::Omniwheel::NEW_2, -1.5);
lemlib::OdomSensors _1028A::robot::sensors(&vertical, nullptr, &horizontal, nullptr, &inertial);
lemlib::ControllerSettings _1028A::robot::lateralController(10, 0, 3, 3, 1, 100, 3, 500, 20);
lemlib::ControllerSettings _1028A::robot::angularController(3, 0, 10, 3, 1, 100, 3, 500, 0);
