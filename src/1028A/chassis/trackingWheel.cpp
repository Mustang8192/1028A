...
_1028A::TrackingWheel::TrackingWheel(pros::ADIEncoder *encoder,
...
_1028A::TrackingWheel::TrackingWheel(pros::Rotation *encoder,
                                     float wheelDiameter, float distance,
                                     float gearRatio) {
...
_1028A::TrackingWheel::TrackingWheel(pros::Motor_Group *motors,
                                     float wheelDiameter, float distance,
                                     float rpm) {
  this->motors = motors;
