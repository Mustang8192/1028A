...
_1028A::odom::Pose odomPose(0, 0, 0); // the pose of the robot
 ...
 */
void _1028A::odom::setSensors(_1028A::OdomSensors_t sensors,
 ...
 * @return Pose
 */
_1028A::odom::Pose _1028A::odom::getPose(bool radians) {
  if (radians)
    return odomPose;
  else
    return Pose(odomPose.x, odomPose.y,
                _1028A::utils::misc::radToDeg(odomPose.theta));
}
 ...
 * default
 */
void _1028A::odom::setPose(Pose pose, bool radians) {
  if (radians)
    odomPose = pose;
  else
    odomPose = Pose(pose.x, pose.y, _1028A::utils::misc::degToRad(pose.theta));
}
...
void _1028A::odom::update() {
  ...
  if (odomSensors.imu != nullptr)
    imuRaw = _1028A::utils::misc::degToRad(odomSensors.imu->get_rotation());
