 ...
 */
_1028A::TrackingWheel::TrackingWheel(pros::ADIEncoder *encoder, float diameter,
 ...
 * @param gearRatio gear ratio of the tracking wheel, defaults to 1
 */
_1028A::TrackingWheel::TrackingWheel(pros::Rotation *encoder, float diameter,
                                     float distance, float gearRatio) {
 ...
 */
_1028A::TrackingWheel::TrackingWheel(pros::Motor_Group *motors, float diameter,
 ...
 *
 */
void _1028A::TrackingWheel::reset() {
 ...
 */
float _1028A::TrackingWheel::getDistanceTraveled() {
  if (this->encoder != nullptr) {
    ...
    return _1028A::utils::misc::avg(distances);
  } else {
    return 0;
  }
}
 ...
 */
float _1028A::TrackingWheel::getOffset() { return this->distance; }
 ...
 */
int _1028A::TrackingWheel::getType() {
  if (this->motors != nullptr)
    return 1;
  return 0;
}
